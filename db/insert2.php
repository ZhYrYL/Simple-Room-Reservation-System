<?php
    ...
    if(isset($_POST['paynow'])){
        ...
        $mail->Subject = 'Welcome to CJLPP Hotel, Your booking has been confirmed';
        $mail->Body = '<b>Congratulations!</b>  your booking at the CJLPP Hotel has been confirmed. We look forward to welcoming you to our hotel';
